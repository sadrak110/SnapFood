...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2022 at 09:02 AM
...
CREATE TABLE `comments` (
  ...
  `cart_id` bigint(20) UNSIGNED NOT NULL,
  `restaurant_id` bigint(20) UNSIGNED NOT NULL,
  `status` bigint(20) UNSIGNED NOT NULL DEFAULT 2,
...
CREATE TABLE `coupons` (
  ...
  `uses_number` int(10) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `foods` (
  ...
  `food_ingredients` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, '2013_06_25_190955_create_app_roles_table', 1),
(2, '2014_10_12_000000_create_users_table', 1),
(3, '2014_10_12_100000_create_password_resets_table', 1),
(4, '2014_10_12_200000_add_two_factor_columns_to_users_table', 1),
(5, '2019_08_19_000000_create_failed_jobs_table', 1),
(6, '2019_12_14_000001_create_personal_access_tokens_table', 1),
(7, '2022_06_21_135235_create_restaurant_categories_table', 1),
(8, '2022_06_22_075326_create_sessions_table', 1),
(9, '2022_06_22_124853_create_restaurants_table', 1),
(10, '2022_06_23_135601_create_food_categories_table', 1),
(11, '2022_06_23_135624_create_foods_table', 1),
(12, '2022_06_25_141242_create_coupons_table', 1),
(13, '2022_06_28_151712_create_order_statuses_table', 1),
(14, '2022_06_29_215802_create_carts_table', 1),
(15, '2022_06_30_144252_create_cart_items_table', 1),
(16, '2022_06_30_184834_create_addresses_table', 1),
(17, '2022_07_19_124908_create_jobs_table', 1),
(18, '2022_07_20_211815_create_comments_table', 1),
(19, '2022_07_22_151352_create_restaurant_comment_answers_table', 1),
(20, '2022_07_23_162642_create_comment_statuses_table', 1);
...
CREATE TABLE `restaurants` (
  ...
  `restaurant_image` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `restaurant_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `restaurant_phone` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `restaurant_address` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`restaurant_address`)),
...
--
-- Table structure for table `restaurant_comment_answers`
--

CREATE TABLE `restaurant_comment_answers` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Indexes for table `restaurant_comment_answers`
--
ALTER TABLE `restaurant_comment_answers`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `restaurant_comment_answers`
--
ALTER TABLE `restaurant_comment_answers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
